"use strict";(self.webpackChunkfp_go_docs=self.webpackChunkfp_go_docs||[]).push([["8537"],{1100(e,r,t){t.r(r),t.d(r,{metadata:()=>n,default:()=>l,frontMatter:()=>s,contentTitle:()=>c,toc:()=>u,assets:()=>a});var n=JSON.parse('{"id":"advanced/architecture","title":"Architecture Patterns","description":"Design scalable functional applications with hexagonal architecture, clean architecture, domain-driven design, and CQRS patterns.","source":"@site/docs/advanced/architecture.md","sourceDirName":"advanced","slug":"/advanced/architecture","permalink":"/fp-go/docs/advanced/architecture","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"title":"Architecture Patterns","hide_title":true,"description":"Design scalable functional applications with hexagonal architecture, clean architecture, domain-driven design, and CQRS patterns.","sidebar_position":4},"sidebar":"apiSidebar","previous":{"title":"Performance Optimization","permalink":"/fp-go/docs/advanced/performance"}}'),i=t(4848),o=t(8453);let s={title:"Architecture Patterns",hide_title:!0,description:"Design scalable functional applications with hexagonal architecture, clean architecture, domain-driven design, and CQRS patterns.",sidebar_position:4},c,a={},u=[];function d(e){let r={p:"p",...(0,o.R)(),...e.components},{CodeCard:t,PageHeader:n,Section:s,TLDR:c,TLDRCard:a}=r;return t||m("CodeCard",!0),n||m("PageHeader",!0),s||m("Section",!0),c||m("TLDR",!0),a||m("TLDRCard",!0),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(n,{eyebrow:"Advanced \xb7 04 / 04",title:"Architecture",titleAccent:"Patterns",lede:"Design scalable functional applications with hexagonal architecture, clean architecture, domain-driven design, CQRS, event sourcing, and effect systems.",meta:[{label:"Difficulty",value:"Expert"},{label:"Topics",value:"6"},{label:"Prerequisites",value:"DDD, CQRS, Event Sourcing"}]}),"\n",(0,i.jsxs)(c,{children:[(0,i.jsx)(a,{title:"Hexagonal Architecture",icon:"box",children:(0,i.jsx)(r.p,{children:"Isolate business logic from infrastructure with ports and adapters for testability."})}),(0,i.jsx)(a,{title:"Clean Architecture",icon:"layers",children:(0,i.jsx)(r.p,{children:"Organize code in concentric layers with dependency inversion for maintainability."})}),(0,i.jsx)(a,{title:"Effect Systems",icon:"zap",children:(0,i.jsx)(r.p,{children:"Track side effects in types with IO, Reader, and monad transformers for composability."})})]}),"\n",(0,i.jsxs)(s,{id:"hexagonal",number:"01",title:"Hexagonal",titleAccent:"Architecture",children:[(0,i.jsx)(r.p,{children:"Isolate business logic from infrastructure concerns using ports and adapters."}),(0,i.jsx)(t,{file:"hexagonal_domain.go",children:`package domain
...
`}),(0,i.jsx)(t,{file:"hexagonal_adapter.go",children:`package postgres
...
`})]}),"\n",(0,i.jsxs)(s,{id:"clean-architecture",number:"02",title:"Clean",titleAccent:"Architecture",children:[(0,i.jsx)(r.p,{children:"Organize code in concentric layers with dependency inversion."}),(0,i.jsx)(t,{file:"clean_layers.go",children:`// Layer 1: Entities (innermost - pure domain)
package entities
...
`})]}),"\n",(0,i.jsxs)(s,{id:"ddd",number:"03",title:"Domain-Driven",titleAccent:"Design",children:[(0,i.jsx)(r.p,{children:"Model complex domains with aggregates, value objects, and domain events."}),(0,i.jsx)(t,{file:"ddd_aggregate.go",children:`package domain
...
`})]}),"\n",(0,i.jsxs)(s,{id:"cqrs",number:"04",title:"CQRS",titleAccent:"Pattern",children:[(0,i.jsx)(r.p,{children:"Separate read and write models for scalability and optimization."}),(0,i.jsx)(t,{file:"cqrs_commands.go",children:`package commands
...
`}),(0,i.jsx)(t,{file:"cqrs_queries.go",children:`package queries
...
`})]}),"\n",(0,i.jsxs)(s,{id:"event-sourcing",number:"05",title:"Event",titleAccent:"Sourcing",children:[(0,i.jsx)(r.p,{children:"Store state changes as a sequence of events for auditability and time travel."}),(0,i.jsx)(t,{file:"event_sourcing.go",children:`package eventsourcing
...
`})]}),"\n",(0,i.jsxs)(s,{id:"effect-systems",number:"06",title:"Effect",titleAccent:"Systems",children:[(0,i.jsx)(r.p,{children:"Track side effects in types for composability and testability."}),(0,i.jsx)(t,{file:"effect_system.go",children:`package effects
...
`})]})]})}function l(e={}){let{wrapper:r}={...(0,o.R)(),...e.components};return r?(0,i.jsx)(r,{...e,children:(0,i.jsx)(d,{...e})}):d(e)}function m(e,r){throw Error("Expected "+(r?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}},8453(e,r,t){t.d(r,{R:()=>s,x:()=>c});var n=t(6540);let i={},o=n.createContext(i);function s(e){let r=n.useContext(o);return n.useMemo(function(){return"function"==typeof e?e(r):{...r,...e}},[r,e])}function c(e){let r;return r=e.disableParentContext?"function"==typeof e.components?e.components(i):e.components||i:s(e.components),n.createElement(o.Provider,{value:r},e.children)}}}]);